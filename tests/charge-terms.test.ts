...
const PAID = {
  ...
  validityAmount: 2,
  validityUnit: "month",
  category: "group" as const, classDays: null, expiresOn: null,
};
...
describe("itemForCredit — a complete snapshot wins over the live item", () => {
  ...
  it("supports a custom DAY validity snapshot", () => {
    const out = itemForCredit(LIVE_EDITED, {
      ...
      validityAmount: 45,
      validityUnit: "day",
      category: "group", classDays: null, expiresOn: null,
    });
...
describe("itemForCredit — legacy and partial snapshots fall back", () => {
  ...
  it("a half-written snapshot is legacy, NOT a mix of paid and live terms", () => {
    for (const partial of [
      { hours: 10, validity: null, validityAmount: null, validityUnit: null, category: null, classDays: null, expiresOn: null },
      { hours: null, validity: "two_months", validityAmount: 2, validityUnit: "month", category: null, classDays: null, expiresOn: null },
      { hours: 10, validity: null, validityAmount: null, validityUnit: null, category: "group" as const, classDays: null, expiresOn: null },
    ]) {
